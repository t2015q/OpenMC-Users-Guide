...
fuel.set_density('atom/b-cm',.06170524)
...
ss_plate.add_element('Cr',1.7638e-2 )
ss_plate.add_nuclide('Mn55'1.4394e-3)
ss_plate.add_nuclide('B10'，1.3953e-3 ）
ss_plate.add_nuclide('B11'，5.6163e-3 ）
ss_plate.add_element('Cu',1.9145e-4)
ss_plate.add_element('Fe',5.5634e-2 )
ss_plate.add_element('Ni',8.0684e-3)
ss_plate.add_element('Mo',1.5119e-4)
ss_plate.set_density('g/cm3',7.77)
...
xp10=openmc.XPlane(x0=28.628 )
xp11=openmc.XPlane(x0= 0.0)

xp15=openmc.XPlane(x0=32.088)
xp14=openmc.XPlane(x0=74.188)

xp17=openmc.XPlane(x0=77.648)
xp16=openmc.XPlane(x0=106.276)

yp19=openmc.YPlane(y0=0.0 )
yp20=openmc.YPlane(y0=33.68 )

zp22=openmc.ZPlane(z0= 96.52)  #top of fuel rod
zp23=openmc.ZPlane(z0= -1.27)

#side of water reflector
xp24=openmc.XPlane(x0=136.276 ,boundary_type='vacuum')
xp25=openmc.XPlane(x0=-30,boundary_type='vacuum')
yp26=openmc.YPlane(y0=63.68,boundary_type='vacuum' )
...
yp31=openmc.YPlane(y0=-0.96)
yp32=openmc.YPlane(y0=34.64)
xp33=openmc.XPlane(x0=31.79)  #1st plate
xp34=openmc.XPlane(x0=32.088)
xp35=openmc.XPlane(x0=74.188) #2st plate
xp36=openmc.XPlane(x0=74.486)
zp37=openmc.ZPlane(z0=91.5) #plate top
...
#Rectangular Lattices 17*20
lattice1 = openmc.RectLattice()
lattice1.lower_left = (0, 0)
lattice1.pitch = (1.684, 1.684)
lattice1.universes = np.tile(u1, (20, 17))  # 17*20
lattice1.outer=u2

#Rectangular Lattices 25*20
lattice2 = openmc.RectLattice()
lattice2.lower_left = (32.088, 0)
lattice2.pitch = (1.684, 1.684)
lattice2.universes = np.tile(u1, (20, 25))  # 25*20
lattice2.outer=u2

#Rectangular Lattices 20*17
lattice3 = openmc.RectLattice()
lattice3.lower_left = (77.648, 0)
lattice3.pitch = (1.684, 1.684)
lattice3.universes = np.tile(u1, (20, 17))
lattice3.outer=u2


cell8=openmc.Cell()
region8=-xp10 & +xp11 & -yp20 & +yp19 & -zp22 & +zp23
cell8.region=region8
cell8.fill=lattice1


cell9=openmc.Cell()
region9=+xp15 & -xp14 & +yp19 & -yp20 & +zp23 & -zp22
cell9.region= region9
cell9.fill=lattice2


cell10=openmc.Cell()
region10=+yp19 & -yp20 & +xp17 & -xp16 & +zp23 & -zp22
cell10.region= region10
cell10.fill=lattice3

cell11=openmc.Cell()
region11=+yp31 & -yp32 & +xp33 & -xp34 & +zp7 & -zp37
cell11.region=region11
cell11.fill=ss_plate

cell12=openmc.Cell()
region12=+yp31 & -yp32 & +xp35 & -xp36 & +zp7 & -zp37
