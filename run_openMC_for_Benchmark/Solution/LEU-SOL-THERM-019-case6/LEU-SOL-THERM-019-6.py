...
fuel.add_nuclide('H1',5.8665E-02)
fuel.add_nuclide('O16',3.7223E-02)
fuel.add_nuclide('N14',2.1881E-03)
fuel.add_nuclide('U234',6.5542E-07)
fuel.add_nuclide('U235',8.1333E-05)
fuel.add_nuclide('U236',8.1232E-08)
fuel.add_nuclide('U238',7.2444E-04)
fuel.set_density('atom/b-cm',9.88823995E-02)
...
poly=openmc.Material(3,'poly')
poly.add_nuclide('H1',8.3806E-02)
poly.add_element('C',4.1501E-02)
poly.add_s_alpha_beta('c_H_in_CH2')
poly.set_density('atom/b-cm',1.25307000E-01)
...
mats=openmc.Materials([fuel,sus304,poly,air,aluminum,futa304])
...
zp7=openmc.ZPlane(z0= 76.04) #critical level
...
zp24=openmc.ZPlane(z0=153.0)
zp25=openmc.ZPlane(z0= 0.0 )
zp26=openmc.ZPlane(z0= 150.0 )
xp27=openmc.XPlane(x0= -35.7 )
xp28=openmc.XPlane(x0= 35.7)

yp31=openmc.YPlane(y0=16.68 )
yp32=openmc.YPlane(y0=17.49)
yp33=openmc.YPlane(y0=22.52)
yp34=openmc.YPlane(y0=23.33)
yp35=openmc.YPlane(y0=-16.68)
yp36=openmc.YPlane(y0=-17.49)

yp37=openmc.YPlane(y0=-22.52)
yp38=openmc.YPlane(y0=-23.33)
yp39=openmc.YPlane(y0=23.46)
yp40=openmc.YPlane(y0=24.27)
yp41=openmc.YPlane(y0=39.35)
yp42=openmc.YPlane(y0=40.16)
yp43=openmc.YPlane(y0=-23.46)
yp44=openmc.YPlane(y0=-24.27)
yp45=openmc.YPlane(y0=-39.35)
yp46=openmc.YPlane(y0=-40.16)
