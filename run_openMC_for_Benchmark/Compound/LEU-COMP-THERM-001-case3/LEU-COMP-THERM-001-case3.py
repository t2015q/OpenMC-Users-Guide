...
xp12=openmc.XPlane(x0= 49.05) #second boundary
xp13=openmc.XPlane(x0= 89.69)

xp14=openmc.XPlane(x0= 98.1)#third
xp15=openmc.XPlane(x0= 138.74)
...
xp24=openmc.XPlane(x0=168.74 ,boundary_type='vacuum')
...
#Rectangular Lattices 20*16(x*y)
...
lattice2.lower_left = (49.05,0 )
lattice2.pitch = (2.032, 2.032)
lattice2.universes = np.tile(u1, (16, 20))  
lattice2.outer=u2


#Rectangular Lattices 20*16(x*y)
lattice3 = openmc.RectLattice()
lattice3.lower_left = (98.1,0 )
