...
xp14=openmc.XPlane(x0=85.695)
xp15=openmc.XPlane(x0=52.675)
xp16=openmc.XPlane(x0=138.37)
xp17=openmc.XPlane(x0=105.35)
...
xp24=openmc.XPlane(x0=181.685 ,boundary_type='vacuum')
xp25=openmc.XPlane(x0=-43.315,boundary_type='vacuum')
...
yp31=openmc.YPlane(y0=-10.86)
yp32=openmc.YPlane(y0=31.18)
xp33=openmc.XPlane(x0=-12.815)
xp34=openmc.XPlane(x0=151.185)

zp36=openmc.ZPlane(z0=103.3375)
yp37=openmc.YPlane(y0=-0.66)
yp38=openmc.YPlane(y0=20.98)
##堆芯部分
#uo2 fuel
cell1=openmc.Cell()
