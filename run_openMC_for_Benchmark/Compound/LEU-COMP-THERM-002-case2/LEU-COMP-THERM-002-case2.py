...
yp20=openmc.YPlane(y0=35.56 )
yp21=openmc.YPlane(y0=2.54 )

zp23=openmc.ZPlane(z0= -2.2225)

#side of water reflector
xp24=openmc.XPlane(x0=52.86 ,boundary_type='vacuum')
xp25=openmc.XPlane(x0=-30,boundary_type='vacuum')
yp26=openmc.YPlane(y0=65.56,boundary_type='vacuum' )
...
#Rectangular Lattices 9*13(x*y)
lattice1 = openmc.RectLattice()
lattice1.lower_left = (0, 2.54)
lattice1.pitch = (2.54, 2.54)
lattice1.universes = np.tile(u1, (13, 9))
lattice1.outer=u2


#Rectangular Lattices 3*1(x*y)
lattice2 = openmc.RectLattice()
lattice2.lower_left = (0, 0)
lattice2.pitch = (2.54, 2.54)
lattice2.universes = np.tile(u1, (1, 3))
lattice2.outer=u2
