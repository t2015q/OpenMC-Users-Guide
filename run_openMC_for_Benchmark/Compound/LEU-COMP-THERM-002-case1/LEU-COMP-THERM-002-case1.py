...
xp24=openmc.XPlane(x0=55.4 ,boundary_type='vacuum')
xp25=openmc.XPlane(x0=-30,boundary_type='vacuum')
yp26=openmc.YPlane(y0=60.48,boundary_type='vacuum' )
