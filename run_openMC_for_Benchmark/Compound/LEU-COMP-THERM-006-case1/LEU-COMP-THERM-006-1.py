...
#lattice
xp10=openmc.XPlane(x0=35.131)
xp11=openmc.XPlane(x0=0.)
yp20=openmc.YPlane(y0=35.131)
yp19=openmc.YPlane(y0=0.)



sph9=openmc.Sphere(x0=17.566,y0=17.566,z0=72.075,R=150.0,boundary_type='vacuum')

zp11=openmc.ZPlane(z0= 99.45)  #critical water level=99.45

#water reflector=30.0 cm

xp31=openmc.XPlane(x0=65.131 )
xp32=openmc.XPlane(x0=-30.)
yp33=openmc.YPlane(y0=65.131)
yp34=openmc.YPlane(y0=-30.)
zp29=openmc.ZPlane(z0=-30.)

##single 19* 19
##critical water level 99.450(cm)
##lattice pitch 1.849(cm)
##water reflector 30.000(cm)
...
#Rectangular Lattices 19*19(x*y)
lattice = openmc.RectLattice()
lattice.lower_left = (0, 0)
lattice.pitch = (1.849, 1.849)
lattice.universes = np.tile(u1, (19, 19))  # 19*19
lattice.outer=u2
